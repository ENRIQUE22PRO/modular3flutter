...
class Sistema {
  ...
  static const String DOMINIO_GLOBAL = 'http://137.184.49.224/';
  ...
  static const String MESAJE_SHARE_LINK =
      'Descarga gratis NutriaFood y encuentra promociones exclusivas.';
  ...
  static const sloganCuriosity =
      'NutriaFood, para las personas que quieren más.';
  static const aplicativoCuriosity = 'NutriaFood';
  static const idAplicativoCuriosity = 1000001;
  static const aplicativoTitleCuriosity = 'NutriaFood';
  static const packageNameCuriosity = 'com.rover.NutriaFood';
  static const appStoreIdCuriosity = '1488624281';
  static const uriDynamicCuriosity = 'http://137.184.49.224';
  ...
  static get uriPrefix =>
      'https://${aplicativo.toLowerCase()}.http://137.184.49.224'; //La barra al final causa problemas en iOS
